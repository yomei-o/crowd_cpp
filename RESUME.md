...
| 08-21 | Part B, 丸ごと1枚, Adam 2e-6→cosine 4e-8, 20000 step | 2000→213.6 / 4000→69.9 / 6000→69.2 / 8000→**43.61**（昨日と一致）/ 10000→47.4 / **12000→34.03** / 14000→56.4 / 16000→34.04（実行中） |
...
| 08-21 | 同じ設定で **Adam 3e-5 → cosine 1.5e-6**、8000 step | 完走。**F1 0.7612**（閾値 0.25、precision 0.872 / recall 0.676）。1000→0.670 / 3000→0.742 / 5000→0.756 / 8000→0.761。振幅は 0.43〜0.48 で lr に依らず ＝ 目的関数の問題と確定 |
